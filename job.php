...
<html>
    <head>
        ...
        <meta charset="utf-8">
        <title>Job Listing | Healthy Connections</title>
    ...
    <body>
        <div class="container">
            ...
            <div class="row poster-block">
                <div>
                    <p>Job Listing by: <b><?php echo $gatheredContent['username']; ?></b></p> 
                </div>
                <div>
            ...
            <p class="form-info">By clicking the above button you accept for Healthy Connections to text the poster of this job opening with your full name, email address and phone number.</p>
        </div>
    </body>
</html>