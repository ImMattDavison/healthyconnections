...
<html>
    <head>
        ...
        <title>Jobs | Healthy Connections</title>
    ...
    <body>
        ...
        <div class="container">
            <h1 style="text-align: center;">All Job Openings</h1>
            <div class="row">
                <?php 
                    $gettrials = mysqli_query($conn, 'SELECT * FROM posts WHERE postType = 2 ORDER BY id DESC');
