<?php
    ...
    if(isset($_POST['submit'])) {
        ...
        $sql = "INSERT INTO posts (postid, trialName, trialDesc, trialPostDate, username, email, phoneNumber, postType) VALUES ('$upid','$trialName', '$trialDescription', '$trialPostDate', '$username', '$email', '$phoneNumber', 1)";
...
<html lang="en">
    ...
    <body>
        ...
        <div class="container">
            <h1>Post an ad for a medical trial</h1>
            <form action='' method='post'>
                <p class="form-item"><label>Trial Name</label><br />
                <input required style="width: 100%" type='text' name='trialName'></p>

                <p class="form-item"><label>Trial Description</label><br />
